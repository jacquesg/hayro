...
[![Crates.io](https://img.shields.io/crates/v/beeld-jbig2.svg)](https://crates.io/crates/beeld-jbig2)
[![Documentation](https://docs.rs/beeld-jbig2/badge.svg)](https://docs.rs/beeld-jbig2)

A memory-safe, pure-Rust JBIG2 decoder.

`beeld-jbig2` decodes JBIG2 images as specified in ITU-T T.88 (also known as
