...
[![Crates.io](https://img.shields.io/crates/v/beeld-jpeg2000.svg)](https://crates.io/crates/beeld-jpeg2000)
[![Documentation](https://docs.rs/beeld-jpeg2000/badge.svg)](https://docs.rs/beeld-jpeg2000)

<!-- cargo-rdme start -->

A memory-safe, pure-Rust JPEG 2000 decoder.

`beeld-jpeg2000` can decode both raw JPEG 2000 codestreams (`.j2c`) and images wrapped
...
at the example in [GitHub](https://github.com/LaurenzV/beeld/blob/main/beeld-jpeg2000/examples/png.rs),
