Test inputs are not committed to git. Instead, they are downloaded on demand from https://beeld-assets.dev under the `jpeg2000` namespace. Each namespace has a manifest file that describes every entry and optional metadata:
