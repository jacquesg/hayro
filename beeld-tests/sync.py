...
FONTS_BASE_URL = "https://beeld-assets.dev/fonts/"
REQUIRED_FONTS = [
...
REMOTE_SOURCES = {
    "custom": ("https://beeld-assets.dev/custom/", "custom"),
    "pdfjs": ("https://beeld-assets.dev/pdfjs/", "pdfjs"),
    "pdfbox": ("https://beeld-assets.dev/pdfbox/", "pdfbox"),
    "pdfium": ("https://beeld-assets.dev/pdfium/", "pdfium"),
    "corpus": ("https://beeld-assets.dev/corpus/", "corpus"),
}
