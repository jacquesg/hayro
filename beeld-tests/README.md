...
This is the test suite for beeld, which mainly aims to ensure there are no regressions
...
- Custom tests, which include custom-selected PDFs (like for example from the beeld issue tracker).
