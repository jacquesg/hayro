...
#[doc(hidden)]
pub fn extract_pages_as_xobject_to_pdf(beeld_pdf: &Pdf, page_indices: &[usize]) -> Vec<u8> {
...
) -> BTreeMap<beeld_syntax::object::Name<'a>, MaybeRef<Object<'a>>> {
...
fn collect_resources_inner<'a>(
    ...
    map: &mut BTreeMap<beeld_syntax::object::Name<'a>, MaybeRef<Object<'a>>>,
) {
...
fn convert_rect(hy_rect: &beeld_syntax::object::Rect) -> Rect {
    Rect::new(
        hy_rect.x0 as f32,
        hy_rect.y0 as f32,
        hy_rect.x1 as f32,
