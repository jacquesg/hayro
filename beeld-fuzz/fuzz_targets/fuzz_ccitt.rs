...
impl beeld_ccitt::Decoder for Decoder {
...
fuzz_target!(|data: &[u8]| {
    ...
    let encoding = match data[7] % 3 {
        0 => beeld_ccitt::EncodingMode::Group4,
        1 => beeld_ccitt::EncodingMode::Group3_1D,
        _ => beeld_ccitt::EncodingMode::Group3_2D {
    ...
    let _ = beeld_ccitt::decode(&data[HEADER_SIZE..], &mut decoder, &mut context);
});
