...
use beeld_cmap::{BfString, CMap, CharacterCollection, CidFamily, WritingMode};
use beeld_syntax::object;
use beeld_syntax::object::Dict;
use beeld_syntax::object::Name;
use beeld_syntax::object::Stream;
use beeld_syntax::object::dict::keys::*;
use beeld_syntax::object::{Array, Object};
...
fn read_encoding(object: &Object<'_>, cmap_resolver: &CMapResolverFn) -> Option<CMap> {
    ...
    match object {
        Object::Name(n) => {
            let cmap_type = beeld_cmap::CMapName::from_bytes(n.deref());
            match cmap_type {
                beeld_cmap::CMapName::IdentityH => Some(CMap::identity_h()),
                beeld_cmap::CMapName::IdentityV => Some(CMap::identity_v()),
                _ => {
