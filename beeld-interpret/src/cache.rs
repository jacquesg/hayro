...
use beeld_syntax::object::{Array, Dict, MaybeRef, Name, Null, ObjRef, Object, Stream};
...
impl CacheKey for beeld_syntax::object::Number {
    fn cache_key(&self) -> u128 {
        hash128(&self.as_f64().to_bits())
    }
}

impl CacheKey for beeld_syntax::object::String<'_> {
    fn cache_key(&self) -> u128 {
        hash128(self.as_ref())
    }
}
