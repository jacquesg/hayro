...
/// Extension methods for converting a [`beeld_syntax::transform::Transform`] to a [`kurbo::Affine`].
pub trait TransformExt {
    /// Convert to a `kurbo::Affine`.
    fn to_kurbo(&self) -> kurbo::Affine;
}

impl TransformExt for beeld_syntax::transform::Transform {
    fn to_kurbo(&self) -> kurbo::Affine {
...
impl RectExt for beeld_syntax::object::Rect {
    fn to_kurbo(&self) -> Rect {
